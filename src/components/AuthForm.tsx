...
export default function AuthForm() {
    ...
    return (
      <div className="mobile-card animate-error-shake">
        <div className="text-center">
          ...
          <p className="text-red-600 font-medium">Supabase 설정 오류</p>
        </div>
      </div>
    )
  }
  ...
  if (user) {
    return (
      <div className="mobile-card animate-success-animation">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-6">{user.email}님</p>
          <button
  ...
  return (
    <div className="mobile-card animate-fade-in">
      ...
      {error && (
        <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-xl animate-error-shake">
      ...
      {success && (
        <div className="mb-6 p-4 bg-green-50 border border-green-200 rounded-xl animate-success-animation">
          <div className="flex items-center">
      ...
      <div className="mt-6">
        ...
        <button
          ...
          disabled={loading}
          className="w-full mt-4 flex items-center justify-center px-4 py-4 border border-gray-300 rounded-2xl bg-white text-gray-700 hover:bg-gray-50 active:bg-gray-100 transition-colors"
        >
